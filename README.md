...
![Tests](https://img.shields.io/badge/tests-65%20passed%20%7C%20100%25-brightgreen?style=flat-square)
...
### 🎯 1. Leads Suite & Telemetry Dashboard
*Real-time diagnostic metrics, dynamic Q-Score gauges, closing propensity prediction, and one-click outreach actions.*

![Alygen Leads Suite](docs/assets/dashboard-main.png)

<br/>

### 🔬 2. Deep Technical Audit & Multi-Agent Market Intelligence
*Full telemetry inspection featuring Predictive ML Conversion (HOT 88%), DuckDuckGo Multi-Agent Local Competitor Benchmarking, live Security/GDPR/WCAG compliance audits, and real-time 3D Web DNA.*

![Interactive Lead Audit Drawer](docs/assets/lead-audit-drawer.png)

<br/>

### 📑 3. Executive Client Diagnostic & Market Audit Report
*Comprehensive client-facing audit view featuring AI-crafted commercial hooks, Core Web Vitals (2026 LCP/INP/CLS), Generative Engine Optimization (AEO/GEO llms.txt citation index), and Google Maps local reputation.*

![Interactive Client Audit Report](docs/assets/client-audit-report.png)

<br/>

| 📊 **Sales Pipeline & Deal Kanban** | ⚡ **Visual Automation Engine** |
|:---:|:---:|
| ![Sales Pipeline](docs/assets/sales-pipeline.png) | ![Visual Automator](docs/assets/visual-automations.png) |
| *Visual deal progression, automated budget calculation, and fiscal invoice tracking.* | *Drag-and-drop workflow canvas for event triggers and omnichannel dispatch.* |
