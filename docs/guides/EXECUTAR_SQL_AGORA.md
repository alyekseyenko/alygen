# 🎯 EXECUTAR AGORA - Schema SQL no Supabase
...
1. Clique neste link: https://supabase.com/dashboard/project/yjlqyyiqjaxezgxfbnfb/editor
2. Ou acesse manualmente:
   - https://supabase.com/dashboard
   - Selecione o projeto `yjlqyyiqjaxezgxfbnfb`
   - Clique em **SQL Editor** no menu lateral (ícone `</>`)
...
2. Ou use o atalho: `Ctrl + K` → `New query`
...
2. Você verá a tabela `lead_analyses` listada
...
Agora o Supabase está 100% configurado e funcionando!

Quando você iniciar o backend (`npm run dev`), todas as análises serão automaticamente salvas no Supabase.
...
3. Faça uma análise de lead
4. Verifique no Supabase Dashboard que a análise foi salva
5. Faça a mesma análise novamente → Será instantânea (cache do Supabase)

---

**💡 Dica:** Mantenha o Supabase Dashboard aberto para ver as análises sendo salvas em tempo real!
