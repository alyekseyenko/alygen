...
export default function ReportPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0B0F19] text-white flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-sm font-medium text-white/60 tracking-wider">Loading intelligent market audit...</p>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#0B0F19] text-white flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-sm text-white/40 max-w-md text-center">
          Could not find a completed analysis for <span className="text-white font-mono">{website}</span>. Please ensure you ran the audit in the main dashboard first.
        </p>
  ...
  const aeo = analysis.aeo || { score: 0, factors: {}, status: 'Not Analyzed', recommendations: [] };
    ...
    <div className="min-h-screen bg-[#070913] text-white selection:bg-[hsl(18,100%,52%)] selection:text-white pb-20 print:bg-white print:text-black">
      ...
      <header className="no-print border-b border-white/[0.05] bg-[#070913]/80 backdrop-blur-md sticky top-0 z-40 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xs font-black tracking-widest text-white/40 uppercase">Commercial Intelligence & Market Audit</h1>
      ...
      <main className="max-w-6xl mx-auto px-6 pt-12 space-y-8">
        ...
        <section className="print-card bg-white/[0.02] border border-white/[0.05] rounded-3xl p-8 flex flex-col lg:flex-row justify-between gap-8 items-stretch relative overflow-hidden">
          <div className="space-y-4 flex-1">
            ...
            <div>
              <h2 className="text-3xl font-black tracking-tight">{analysis.company_name || 'Analyzed Brand'}</h2>
            ...
            {salesHook && (
              <div className="border-l-2 border-[hsl(18,100%,52%)] pl-4 py-1">
                <h3 className="text-xs font-black tracking-widest text-white/40 uppercase mb-1">Recommended Commercial Hook</h3>
            ...
            {agentIntel && (
              <div className="border-l-2 border-orange-500 pl-4 py-1 mt-4">
                <h3 className="text-xs font-black tracking-widest text-white/40 uppercase mb-1">Multi-Agent Intelligence & Market Intel</h3>
          ...
          <div className="flex flex-row sm:flex-col lg:flex-col justify-center items-center gap-6 lg:border-l border-white/[0.05] lg:pl-8 min-w-[200px]">
            ...
            <div className="text-center">
              ...
              <div className="text-[9px] font-bold text-white/30 uppercase tracking-widest mt-1">Multivariate Calibration</div>
            </div>
          </div>
        </section>
        ...
        <div className="pt-6">
          <Tabs defaultValue="overview" className="w-full">
            <TabsList className="w-full max-w-2xl mx-auto grid grid-cols-4 mb-8 bg-white/[0.02] border border-white/[0.05] p-1 rounded-2xl">
              <TabsTrigger value="overview" className="rounded-xl py-2.5 font-bold uppercase tracking-wider text-xs">Overview</TabsTrigger>
              <TabsTrigger value="technical" className="rounded-xl py-2.5 font-bold uppercase tracking-wider text-xs">Technical Audit</TabsTrigger>
              <TabsTrigger value="adn3d" className="rounded-xl py-2.5 font-bold uppercase tracking-wider text-xs">3D Digital DNA</TabsTrigger>
              <TabsTrigger value="pitch" className="rounded-xl py-2.5 font-bold uppercase tracking-wider text-xs">Proposal & Pitch</TabsTrigger>
            </TabsList>
                  ...
                  <section className="print-card bg-white/[0.02] border border-white/[0.05] rounded-3xl p-6 space-y-6">
                    <div className="flex items-center justify-between border-b border-white/[0.05] pb-4">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-black text-sm uppercase tracking-wider">Speed Performance & Core Web Vitals (2026)</h3>
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2 border border-white/[0.03] rounded-2xl p-4 bg-white/[0.01]">
                        ...
                        <p className="text-[10px] text-white/40 leading-relaxed print-text-muted">
                          Time required to render the primary page content. Ideal benchmark is under 2.5s.
                        </p>
                      </div>
                      ...
                      <div className="space-y-2 border border-white/[0.03] rounded-2xl p-4 bg-white/[0.01]">
                        ...
                        <p className="text-[10px] text-white/40 leading-relaxed print-text-muted">
                          Measures user interaction latency with page controls. Ideal benchmark is under 200ms.
                        </p>
                      </div>
                      ...
                      <div className="space-y-2 border border-white/[0.03] rounded-2xl p-4 bg-white/[0.01]">
                        ...
                        <p className="text-[10px] text-white/40 leading-relaxed print-text-muted">
                          Visual stability of the page layout. Prevents unexpected content shifts. Ideal is under 0.1.
                        </p>
                      </div>
                      ...
                      <div className="space-y-2 border border-white/[0.03] rounded-2xl p-4 bg-white/[0.01]">
                        ...
                        <p className="text-[10px] text-white/40 leading-relaxed print-text-muted">
                          Hosting server responsiveness and network latency. Ideal benchmark is under 800ms.
                        </p>
                      </div>
                  ...
                  <section className="print-card bg-white/[0.02] border border-white/[0.05] rounded-3xl p-6 space-y-6">
                    <div className="flex items-center justify-between border-b border-white/[0.05] pb-4">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-black text-sm uppercase tracking-wider">GEO: Generative Engine Optimization (AI Answers)</h3>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <div className="flex items-center justify-between bg-white/5 p-3 rounded-xl border border-white/10">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-semibold text-white/80">llms.txt File</span>
                          </div>
                          {aeo.factors?.hasLlmsTxt ? (
                            <span className="text-[10px] px-2.5 py-0.5 rounded-full font-bold bg-emerald-500/10 text-emerald-400 border-emerald-500/20 uppercase">Detected</span>
                          ) : (
                            <span className="text-[10px] px-2.5 py-0.5 rounded-full font-bold bg-rose-500/10 text-rose-400 border-rose-500/20 uppercase">Missing</span>
                          )}
                        </div>
                        ...
                        <div className="flex items-center justify-between bg-white/5 p-3 rounded-xl border border-white/10">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-semibold text-white/80">AI Bot & Crawler Access</span>
                          </div>
                          {aeo.factors?.aiBotsBlocked ? (
                            <span className="text-[10px] px-2.5 py-0.5 rounded-full font-bold bg-rose-500/10 text-rose-400 border-rose-500/20 uppercase">Blocked</span>
                          ) : (
                            <span className="text-[10px] px-2.5 py-0.5 rounded-full font-bold bg-emerald-500/10 text-emerald-400 border-emerald-500/20 uppercase">Allowed</span>
                          )}
                        </div>
                        ...
                        <div className="flex items-center justify-between bg-white/5 p-3 rounded-xl border border-white/10">
                          ...
                          {aeo.factors?.hasSchema ? (
                            <span className="text-[10px] px-2.5 py-0.5 rounded-full font-bold bg-emerald-500/10 text-emerald-400 border-emerald-500/20 uppercase">Active</span>
                          ) : (
                            <span className="text-[10px] px-2.5 py-0.5 rounded-full font-bold bg-amber-500/10 text-amber-400 border-amber-500/20 uppercase">Partial</span>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="border border-white/[0.03] rounded-2xl p-4 bg-white/[0.01] flex flex-col justify-between">
                        <div className="space-y-1">
                          <span className="text-xs font-black text-white/50 tracking-wider block">Local AI Citability Verification</span>
                          <div className="text-lg font-bold text-white mt-1">
                            {aeo.factors?.searchRank || 'Unlisted'}
                          </div>
                        </div>
                        <div className="mt-4 pt-4 border-t border-white/[0.05]">
                          <div className="flex justify-between text-[10px] text-white/40 font-bold uppercase tracking-widest mb-1">
                            <span>Citability Index</span>
                  ...
                  <section className="print-card bg-white/[0.02] border border-white/[0.05] rounded-3xl p-6 flex flex-col justify-between h-full space-y-6">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between border-b border-white/[0.05] pb-4">
                        <div className="flex items-center gap-2">
                          ...
                          <h3 className="font-black text-sm uppercase tracking-wider">Local Presence & Maps</h3>
                        </div>
                      </div>

                      <div className="space-y-4">
                        <div className="space-y-1">
                          <div className="text-xs text-white/40 font-bold uppercase tracking-widest">Google Maps Reviews</div>
                          <div className="text-3xl font-black text-white">
                            {rating > 0 ? `${rating.toFixed(1)} ★` : 'N/A'}
                          </div>
                          <div className="text-[10px] text-white/30 font-bold uppercase tracking-widest">
                            Based on {reviews_count || 0} verified customer reviews.
                          </div>
                        </div>

                        <div className="space-y-2 pt-2">
                          <div className="text-xs text-white/40 font-bold uppercase tracking-widest">Detected Schema Entities</div>
                    ...
                    <div className="pt-6 border-t border-white/[0.05] space-y-2">
                      <div className="flex items-center gap-2 text-white/60">
                        ...
                        <span className="text-xs font-semibold">Regional Competitive Edge</span>
                      </div>
                      <p className="text-[10px] text-white/40 leading-relaxed print-text-muted">
                        The presence of direct local competitors requires proactive technical optimization to capture AI engine market share.
                      </p>
                    </div>
                  </section>
                </div>
              ...
              {analysis?.sheet_metadata && (
                <section className="print-card bg-white/[0.02] border border-white/[0.05] rounded-3xl p-8 space-y-6">
                  <div className="flex items-center gap-2 border-b border-white/[0.05] pb-4">
                    ...
                    <h3 className="font-black text-sm uppercase tracking-wider">Google Business Profile & Local Market Data</h3>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
                    ...
                    <div className="space-y-4 border-r border-white/[0.03] pr-6">
                      <div className="space-y-1">
                        <span className="text-white/40 font-bold uppercase tracking-widest text-[9px]">Industry / Categories</span>
                      ...
                      <div className="space-y-1">
                        <span className="text-white/40 font-bold uppercase tracking-widest text-[9px]">Ownership Status</span>
                        <p className="text-white font-semibold">
                          {analysis.sheet_metadata.unclaimed_listing === 'true' ? (
                            <span className="text-rose-400 font-bold">⚠️ Unclaimed Business Profile</span>
                          ) : (
                            <span className="text-emerald-400 font-bold">✓ Claimed & Verified</span>
                          )}
                        </p>
                      </div>

                      <div className="space-y-1">
                        <span className="text-white/40 font-bold uppercase tracking-widest text-[9px]">Price Tier</span>
                    ...
                    <div className="space-y-4 border-r border-white/[0.03] pr-6">
                      {analysis.sheet_metadata.operating_hours && (
                        <div className="space-y-1">
                          <span className="text-white/40 font-bold uppercase tracking-widest text-[9px]">Operating Hours</span>
                      ...
                      {analysis.sheet_metadata.service_options && (
                        <div className="space-y-1">
                          <span className="text-white/40 font-bold uppercase tracking-widest text-[9px]">Service Options</span>
                    ...
                    <div className="space-y-4">
                      <div className="space-y-1">
                        <span className="text-white/40 font-bold uppercase tracking-widest text-[9px]">Location & GPS</span>
                      ...
                      <div className="pt-2 flex flex-col gap-2">
                        {analysis.sheet_metadata.reviews_link && (
                          ...
                          >
                            <Search className="w-3 h-3" /> View Google Reviews
                          </a>
                        )}
                        {analysis.sheet_metadata.photos_link && (
                          <a 
                            ...
                            className="px-4 py-2 bg-white/5 border border-white/10 hover:bg-white/10 rounded-xl font-bold uppercase tracking-wider text-[10px] transition-all text-center text-white flex items-center justify-center gap-1.5"
                          >
                            <Printer className="w-3 h-3" /> View Google Maps Photos
                          </a>
                        )}
                      </div>
                    </div>
                  ...
                  {analysis.sheet_metadata.description && (
                    <div className="pt-4 border-t border-white/[0.03] space-y-1">
                      <span className="text-white/40 font-bold uppercase tracking-widest text-[9px]">Google Business Description</span>
              ...
              {aeo.recommendations && aeo.recommendations.length > 0 && (
                <section className="print-card bg-white/[0.02] border border-white/[0.05] rounded-3xl p-8 space-y-6">
                  <div className="flex items-center gap-2 border-b border-white/[0.05] pb-4">
                    ...
                    <h3 className="font-black text-sm uppercase tracking-wider">Actionable Growth & Remediation Roadmap</h3>
                  </div>
                    ...
                    <div className="bg-white/[0.01] border border-white/[0.05] rounded-3xl p-6">
                      <div className="flex items-center justify-between mb-4 pb-4 border-b border-white/5">
                        <div className="flex items-center gap-2">
                          ...
                          <h4 className="text-xs font-black uppercase tracking-wider">Security & SSL</h4>
                        </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between items-center p-3.5 bg-black/20 rounded-xl border border-white/5">
                          <span className="text-white/70 text-xs font-bold">Secure Connection (SSL/HTTPS)</span>
                          <span className={analysis.security.hasSSL ? 'text-emerald-400 text-xs font-black' : 'text-rose-400 text-xs font-black'}>
                            {analysis.security.hasSSL ? '✓ ACTIVE' : '× INACTIVE'}
                          </span>
                        </div>
                        <div className="flex justify-between items-center p-3.5 bg-black/20 rounded-xl border border-white/5">
                          <span className="text-white/70 text-xs font-bold">HTTP Headers (CSP / HSTS)</span>
                          <span className={analysis.security.hasCSP || analysis.security.hasHSTS ? 'text-emerald-400 text-xs font-black' : 'text-rose-400 text-xs font-black'}>
                            {analysis.security.hasCSP || analysis.security.hasHSTS ? '✓ CONFIGURED' : '× MISSING'}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/[0.01] border border-white/[0.05] rounded-3xl p-6">
                      <div className="flex items-center justify-between mb-4 pb-4 border-b border-white/5">
                        <div className="flex items-center gap-2">
                          ...
                          <h4 className="text-xs font-black uppercase tracking-wider">GDPR & Privacy Compliance</h4>
                        </div>
                    ...
                    <div className="bg-white/[0.01] border border-white/[0.05] rounded-3xl p-6">
                      <div className="flex items-center justify-between mb-4 pb-4 border-b border-white/5">
                        <div className="flex items-center gap-2">
                          ...
                          <h4 className="text-xs font-black uppercase tracking-wider">WCAG 2.1 Accessibility</h4>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-black/20 p-3.5 rounded-xl border border-white/5 text-center">
                          <p className="text-[10px] text-white/40 uppercase tracking-widest mb-1">Critical Errors</p>
                          <p className="text-xl font-black text-rose-400">{analysis.accessibility.errors || 0}</p>
                        </div>
                        <div className="bg-black/20 p-3.5 rounded-xl border border-white/5 text-center">
                          <p className="text-[10px] text-white/40 uppercase tracking-widest mb-1">Warnings</p>
                    ...
                    <div className="bg-white/[0.01] border border-white/[0.05] rounded-3xl p-6">
                      <div className="flex items-center justify-between mb-4 pb-4 border-b border-white/5">
                        <div className="flex items-center gap-2">
                          ...
                          <h4 className="text-xs font-black uppercase tracking-wider">Analytics & Tracking Pixels</h4>
                        </div>
                        <span className="text-xs font-black text-emerald-400">{analysis.pixelDetails.totalTracking || 0} Detected</span>
                      </div>
                      <div className="grid grid-cols-2 gap-2">
                        {['facebook', 'ga4', 'gtm', 'hotjar'].map(pixel => (
                          <div key={pixel} className={`p-3 rounded-xl border text-center ${
                            ...
                            <p className="text-[9px] font-black mt-1">
                              {analysis.pixelDetails[pixel] ? '✓ DETECTED' : '× INACTIVE'}
                            </p>
                          </div>
                        ))}
                      </div>
            ...
            <TabsContent value="adn3d" className="space-y-6 outline-none">
              <div className="bg-white/[0.01] border border-white/[0.05] rounded-3xl p-8 space-y-4">
                <div className="flex items-center gap-2 border-b border-white/[0.05] pb-4">
                  ...
                  <h3 className="font-black text-sm uppercase tracking-wider">3D Digital DNA Interactive Representation</h3>
                </div>
                <p className="text-xs text-white/60 max-w-2xl leading-relaxed">
                  This real-time 3D organic mesh reflects the site's live performance, SEO health, security, and accessibility scores. Drag with mouse to inspect brand technical DNA.
                </p>
                  ...
                  <div className="bg-white/[0.01] border border-white/[0.05] rounded-3xl p-6 space-y-4">
                    <div className="flex items-center justify-between border-b border-white/[0.05] pb-4">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-black text-sm uppercase tracking-wider">Elite Outreach Pitch Template</h3>
                      </div>
                      <Button 
                        onClick={() => {
                      ...
                      >
                        {copied ? (
                          ...
                          <><Copy className="w-3.5 h-3.5 mr-1" /> Copy HTML Code</>
                        )}
                      </Button>
                    </div>
                ...
                <div className="space-y-6">
                  <div className="bg-white/[0.01] border border-white/[0.05] rounded-3xl p-6 space-y-4">
                    <div className="flex items-center gap-2 border-b border-white/[0.05] pb-4">
                      ...
                      <h3 className="font-black text-sm uppercase tracking-wider">Direct WhatsApp Outreach Message</h3>
                    </div>
                    
                    <p className="text-[11px] text-white/50 leading-relaxed">
                      Optimized for initial direct engagement with executive decision makers.
                    </p>
