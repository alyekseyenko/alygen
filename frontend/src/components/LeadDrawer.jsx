...
export default function LeadDrawer({ lead, onClose, onWhatsAppSent, onNoWhatsApp, privacyMode }) {
  ...
  const [mlPrediction, setMlPrediction] = useState(lead.analysis?.ml_prediction || null)
            ...
            <div className="p-6">
                ...
                {!isNoWebsite && (
                  <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className={`rounded-xl p-5 border ${
                          ...
                          {loadingML && !mlPrediction ? (
                            <div className="flex items-center gap-2 text-white/40 py-4">
                              ...
                              <span className="text-xs">Calculating close probability...</span>
                            </div>
                          ) : mlPrediction ? (
                            <>
                              <div className="flex items-end gap-3 mb-3">
                                ...
                                <span className="text-xs text-white/40 mb-2 leading-tight">close<br/>probability</span>
                              </div>
                      ...
                      {/* Local Market Intelligence (DuckDuckGo + Multi-Agent Orchestrator) */}
                      <div className="bg-gradient-to-br from-orange-500/10 via-background to-background border border-orange-500/25 rounded-xl p-5 shadow-lg">
                        ...
                        {agentIntel ? (
                          ...
                          <div className="text-center py-4">
                            ...
                            <p className="text-xs text-muted-foreground mb-3">Benchmark against local competitors and generate high-converting sales hooks.</p>
                            <Button
                            ...
                            >
                              {loadingIntel ? <><RefreshCw className="w-3 h-3 mr-2 animate-spin" /> Analyzing competitors...</> : <><Brain className="w-3 h-3 mr-2" /> Activate Agent Intel</>}
                            </Button>
                          </div>
                        )}
                      </div>
                    ...
                    {effectiveAnalysis?.strategicInsights && (
                      <div className="bg-gradient-to-br from-indigo-500/10 via-background to-background border border-indigo-500/20 rounded-xl p-5">
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <h3 className="text-sm font-bold text-white uppercase tracking-widest">Strategic Positioning</h3>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <Label className="text-[10px] text-muted-foreground uppercase tracking-widest block mb-1">Executive Sales Pitch</Label>
                            <p className="text-xs text-indigo-100 font-medium leading-relaxed">
                              "{effectiveAnalysis.strategicInsights.strategic_recommendation}"
                            </p>
                          </div>
                          <div>
                            <Label className="text-[10px] text-muted-foreground uppercase tracking-widest block mb-2">Detected Digital Vulnerabilities</Label>
                    ...
                    {/* 📊 REAL AUDIT GRID (SEO, Security, GDPR, Accessibility, Tracking) */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="bg-card border border-border rounded-xl p-5">
                          <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-2">
                              ...
                              <h4 className="text-sm font-bold text-white uppercase tracking-widest">WCAG Accessibility</h4>
                            </div>
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            ...
                            <div className="bg-muted/30 p-3 rounded-lg text-center">
                              <p className="text-[10px] text-muted-foreground uppercase tracking-widest mb-1">Warnings</p>
                        ...
                        <div className="bg-card border border-border rounded-xl p-5 col-span-1 md:col-span-2">
                          <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-2">
                              ...
                              <h4 className="text-sm font-bold text-white uppercase tracking-widest">Conversion & Analytics Tracking</h4>
                            </div>
              ...
              <TabsContent value="email" className="space-y-4">
                <div className="bg-card border border-border rounded-lg p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl font-semibold text-white">Personalized Outreach Pitch</h3>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {availableEmails.length === 0 && (
                      <div className="bg-accent/5 border border-accent/20 rounded-lg p-4">
                        ...
                        <p className="text-xs text-muted-foreground">Manually enter client email</p>
                      </div>
                    )}
                  ...
                  {emailSent && (
                    <div className="bg-accent/5 border border-accent/20 rounded-lg p-4 mt-4">
                      <p className="text-sm text-accent font-medium text-center">
                        Email sent successfully to {customEmail || selectedEmail}
                      </p>
                    </div>
                  )}
                  ...
                  {lead.sequenceStatus && (
                    <div className="mt-8 bg-blue-500/5 border border-blue-500/20 rounded-xl p-6">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          <h4 className="text-sm font-bold text-white uppercase tracking-wider">Email Sequence Tracking</h4>
          ...
          <div className="hidden md:flex w-[35%] h-full bg-[#0e0f14] border-l border-border flex-col overflow-y-auto">
            ...
            <div className="p-6 border-b border-border bg-black/20">
              <h4 className="text-xs font-bold text-accent uppercase tracking-wider mb-3 flex items-center gap-2">
                <Brain className="w-4 h-4 text-accent animate-pulse" /> 3D Website Digital DNA
              </h4>
              <div className="h-[250px] bg-black/50 rounded-xl border border-border overflow-hidden relative shadow-inner group">
                ...
                <div className="absolute bottom-2 left-2 right-2 bg-black/60 backdrop-blur-sm p-1.5 rounded-lg border border-white/5 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
                  <p className="text-[10px] text-white/80 text-center">Rotate and drag with mouse to inspect</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 border-b border-border bg-accent/5">
              <h4 className="text-xs font-bold text-white uppercase tracking-wider mb-3 flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-accent" /> AI Copywriting Engine
              </h4>
              <p className="text-xs text-muted-foreground mb-4">
                Select consultative tone of voice to craft persuasive outreach with local market intel:
              </p>
              
              <div className="space-y-3 mb-4">
                <label className="text-[11px] font-bold text-white/50 uppercase block">Copywriting Style:</label>
                <div className="grid grid-cols-1 gap-2">
                  ...
                  >
                    <span>Vadym's Strategy (Senior Executive)</span>
                    <span className="text-[10px] text-muted-foreground font-normal">Persuasive, ROI-driven & local competitor benchmarking.</span>
                  </button>
                  ...
                  >
                    <span>Technical Security Auditor</span>
                    <span className="text-[10px] text-muted-foreground font-normal">Precise, focused on security vulnerabilities and GDPR.</span>
                  </button>
                  ...
                  >
                    <span>Rapid Direct Response</span>
                    <span className="text-[10px] text-muted-foreground font-normal">Concise, punchy hooks engineered to book meetings.</span>
                  </button>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                >
                  {loadingCopy ? 'Generating...' : 'Generate Pitch Email'}
                </Button>
                <Button
                ...
                >
                  {loadingCopy ? 'Generating...' : 'Generate WhatsApp'}
                </Button>
              </div>
            </div>
            ...
            <div className="p-6 space-y-4">
              <h4 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2">
                <Zap className="w-4 h-4 text-orange-400" /> Close Probability (Machine Learning)
              </h4>
              
              {loadingML ? (
                <div className="flex items-center gap-2 text-xs text-muted-foreground">
                  <RefreshCw className="w-4 h-4 animate-spin text-accent" />
                  <span>Analyzing close probability via Python ML...</span>
                </div>
              ) : mlPrediction ? (
                <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-2">
                  ...
                  <p className="text-[11px] text-muted-foreground mt-2 leading-relaxed">
                    Our model calculated this probability analyzing local competitors, {lead.rating || 'N/A'}-star rating, and technical website gaps.
                  </p>
                </div>
              ) : (
                <p className="text-xs text-muted-foreground">Python ML model in auto-calibration mode.</p>
              )}
            </div>
